...
import com.tkzc00.kongapibackend.model.dto.userInterfaceInfo.UserInterfaceInfoAddRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Page<UserInterfaceInfo>> listInterfaceInfoByPage(UserInterfaceInfoQueryRequest userInterfaceInfoQueryRequest, HttpServletRequest request) {
        ...
        // 限制爬虫
        if (size > 50) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "每页显示条数最大为 50");
        }
        QueryWrapper<UserInterfaceInfo> queryWrapper = new QueryWrapper<>(userInterfaceInfoQuery);
